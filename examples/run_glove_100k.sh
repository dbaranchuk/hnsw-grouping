...
path_data="${PWD}/data/GLOVE100K"
path_model="${PWD}/models/GLOVE100K"
path_base="${path_data}/glove_base.fvecs"
path_learn="${path_data}/glove_learn.fvecs"
path_gt="${path_data}/test_gt.ivecs"
path_q="${path_data}/glove_query.fvecs"
