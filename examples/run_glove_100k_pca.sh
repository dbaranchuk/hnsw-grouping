...
path_data="${PWD}/data/GLOVE100K_200D"
path_model="${PWD}/models/GLOVE100K_200D"
path_base="${path_data}/glove_base_pca${d}.fvecs"
path_learn="${path_data}/glove_learn_pca${d}.fvecs"
path_gt="${path_data}/test_gt.ivecs"
path_q="${path_data}/glove_query_pca${d}.fvecs"
